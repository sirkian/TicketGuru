...
public class TicketRepositoryTest {
    ...
    public void createTicket() {
        ...
        Venue venue = new Venue("Testipaikka", "Testikuvaus", "Testikuja 2", postcode);
        vRepo.save(venue);
        Event event = new Event("Testitapahtuma", "Tapahtuman kuvaus", LocalDateTime.of(2023, 2, 14, 16, 00),
                LocalDateTime.of(2023, 2, 14, 18, 00), 100, LocalDateTime.of(2023, 2, 12, 18, 00), false, venue);
        eRepo.save(event);
