...
public class AppUserRepositoryTest {
	...
	public void createAppUser() {
		...
		// phoneNum, String details, String address, PostalCode postalCode
		AppUser appuser = new AppUser("Testi", "Testaaja", "test@ticketguru.com",
				"salasanaHASH", "+3584044040", "Tosi hyvä dude", "Osoitekatu 1", new PostalCode("00100", "Helsinki"));
	...
	/*
	 * //Testi aiemmin ohjelman kaataneesta hausta listan kanssa (sama testi kuin
	 * yllä siis), ei toimi jostain syystä
	 * 
	 * @Test
	 * public void findUserByEmailShouldReturnUser() {
	 * List<AppUser> appusers =
	 * auRepository.findByEmailFromList("make@tiketguru.com");
