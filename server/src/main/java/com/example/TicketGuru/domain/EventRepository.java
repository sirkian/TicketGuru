...
public interface EventRepository extends CrudRepository<Event, Long> {
	...
	@Query(value = "SELECT COUNT(TICKET_ID) FROM TICKET WHERE EVENT_TYPE_ID IN (SELECT  EVENT_TYPE_ID  FROM EVENT_TICKET_TYPE WHERE EVENT_ID = :eventId AND EVENT_TYPE_ID= :typeId)", nativeQuery = true)
